  ...
  kojare: [
    {
      ...
      items: [
        ...
        { id: 'kj-k18', label: 'ディスペンサー補充、しまってあるか' },
        { id: 'kj-k19', label: '乾物補充' },
        { id: 'kj-k20', label: '揚場補充' },
        { id: 'kj-k21', label: '油補充' },
        { id: 'kj-k22', label: 'レンジ拭き' },
