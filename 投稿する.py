...
def えらぶ(並び, 履歴, 店舗, 日付, 枚数, かならず区分="", かならず枚数=1):
    ...
    def 順番(もの):
        ...
        # ★まず「長く出していないなかま」から。これが無いと、写真の多い
        #   アサイーボウルばかりが続いてしまう（実際に8月にそうなった）
        return (よけい, イベント優先, -なかまの何日前(もの),
                -何日前(履歴, 鍵, 日付), ばらつき(もの))
